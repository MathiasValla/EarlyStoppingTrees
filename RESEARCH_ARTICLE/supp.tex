...
\begin{abstract}
This supplementary document provides the additional figures supporting the main manuscript: Supplementary Figure~S1 on size-stratified Pareto comparisons, Supplementary Figure~S2 on the screening analysis of the parametric secretary strategy, Supplementary Figures~S3--S5 on ridgeline summaries of within-dataset variability, Supplementary Figures~S7 and~S12 on reliability and joint-success plots, Supplementary Figure~S8 on tolerance-constrained quickest-method regime maps, Supplementary Figures~S9--S11 on within-dataset whisker summaries, Supplementary Figure~S13 on exhaustive gain-landscape diagnostics for the regression--classification asymmetry, and Supplementary Figures~S14--S15 on split-search effort comparisons using the selected \(S_{\mathrm{par}}\) representative.
\end{abstract}
